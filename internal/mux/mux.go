...
const (
	...
	defaultKeepAliveInterval      = 30 * time.Second  // detect dead connections before NAT/firewall drops idle state
	defaultConnectionWriteTimeout = 30 * time.Second  // fail fast on dead connections instead of blocking 2 minutes
