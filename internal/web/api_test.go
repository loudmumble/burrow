...
func (m *mockProvider) StartTap(sessionID, iface string) error   { return nil }
func (m *mockProvider) StopTap(sessionID string) error           { return nil }
func (m *mockProvider) IsTapActive(sessionID string) bool        { return false }
...
func (m *mockProvider) StartSOCKS5(sessionID, listenAddr string) error { return nil }
func (m *mockProvider) StopSOCKS5(sessionID string) error              { return nil }
...
func (m *mockProvider) SleepAgent(sessionID string, d time.Duration) error { return nil }
func (m *mockProvider) UpgradeAgent(sessionID string, binary []byte, args []string) error { return nil }
func (m *mockProvider) BuildTopology() string { return "[Server]\n  └── (mock)\n" }
func (m *mockProvider) SetLabel(sessionID, label string) {}
func (m *mockProvider) GetLabel(sessionID string) string { return "" }
func (m *mockProvider) ScanSubnet(_ context.Context, sessionID, cidr, ports string, _ func(*discovery.Target)) ([]*discovery.Target, error) {
	return nil, nil
}
func (m *mockProvider) GetScanResults(sessionID string) []*discovery.Target { return nil }
func (m *mockProvider) SetHostNote(ip, note string) {}
func (m *mockProvider) GetHostNote(ip string) string { return "" }
